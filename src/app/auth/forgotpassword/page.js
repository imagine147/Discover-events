        ...
        <div className="w-full h-full flex flex-col items-center lg:justify-center" style={{opacity: 1, transform: "none"}}>
          ...
          <form id="forgotpassword" className="w-full mt-1 lg:pr-16" onSubmit={handleSubmit (onSubmit)}>
            <div className="mb-3">
              ...
              <h4 onClick={handleBack} className="text-sm font-normal text-[#767779] flex gap-1 cursor-pointer"><BsArrowLeft className="w-5 h-5" width={32} height={32}/>Back to previous</h4>
          </form>
        </div>
      </div>
      <AuthImage/>
